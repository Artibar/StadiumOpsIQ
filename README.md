...
1. **Agent 1 — Intake Agent**: Detects incoming language, translates Hindi inputs to English, maps the selected venue to its geographical coordinates, and parses the initial payload.
